...
An instance binds the global API key and chosen model, so a request never
...
class LLMProvider(ABC):
    """A chat provider bound to the global API key and chosen model."""
    ...
    def __init__(
        ...
        """
        Bind the global stored key and chosen model to this instance.
